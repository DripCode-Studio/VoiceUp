...
const AuthGuard = ({ onLogin, onRegister }: any) => (
  <View style={guardStyles.container}>
    ...
    <Text style={guardStyles.subtitle}>Your voice matters. Log in to start drafting your movement and gather signatures.</Text>
  ...
  if (!user) {
    return (
      <AuthGuard 
        ...
        onRegister={() => navigation.navigate('Register', { returnTo: 'CreateTab' })} 
      />
    );
  }
      ...
      >
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.headerSection}>
            ...
            <Text style={styles.headerSubtitle}>Every major change starts with a single voice. Be clear, be bold, and define the future you want to see.</Text>
          </View>
          ...
          <View style={styles.canvas}>
            ...
            <View style={styles.inputGroup}>
              ...
              />
              <Text style={styles.inputHint}>Make it punchy. 10 words or less is ideal.</Text>
            </View>

            {/* Image Placeholder */}
            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>COVER IMAGE</Text>
              <TouchableOpacity activeOpacity={0.8} style={styles.imagePlaceholder}>
                <View style={styles.imageIconWrap}>
                   <MaterialIcons name="add-a-photo" size={32} color={COLORS.primary} />
                </View>
                <Text style={styles.imagePlaceholderTitle}>Upload a compelling visual</Text>
            ...
            <View style={styles.tipsGrid}>
              <View style={styles.tipCard}>
                <MaterialIcons name="lightbulb" size={24} color={COLORS.primary} style={{marginTop: 2}} />
                <View style={{flex: 1}}>
                  <Text style={styles.tipTitle}>Be Specific</Text>
                  <Text style={styles.tipDesc}>Address a specific person or organization that has the power to make the change.</Text>
                </View>
              </View>
              <View style={styles.tipCard}>
                <MaterialIcons name="group" size={24} color={COLORS.primary} style={{marginTop: 2}} />
                <View style={{flex: 1}}>
                  <Text style={styles.tipTitle}>Stay Personal</Text>
                  <Text style={styles.tipDesc}>People sign when they feel an emotional connection to your story.</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.actionWrap}>
              <TouchableOpacity style={styles.launchBtn} activeOpacity={0.9} onPress={handleCreate}>
                 <Text style={styles.launchBtnText}>Launch Petition</Text>
                 <MaterialIcons name="rocket-launch" size={24} color="#fff" />
              </TouchableOpacity>
              <Text style={styles.termsText}>By launching, you agree to our Community Guidelines and Terms of Service.</Text>
            </View>
