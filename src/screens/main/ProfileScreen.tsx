...
const AuthGuard = ({ onLogin, onRegister }: any) => (
  <View style={guardStyles.container}>
    ...
    <Text style={guardStyles.subtitle}>
      Log in to view your civic profile, track your impact, and manage your
      petitions.
    </Text>
...
export const ProfileScreen = () => {
  ...
  const [activeTab, setActiveTab] = useState<"my_petitions" | "signed">(
    "my_petitions",
  );
  ...
  if (!user) {
    return (
      <AuthGuard
        ...
        onRegister={() =>
          navigation.navigate("Register", { returnTo: "ProfileTab" })
        }
      />
    );
  }
        ...
        <View style={styles.heroSection}>
          <View style={styles.heroLayout}>
            <View style={styles.avatarLargeWrap}>
              <Image
                source={{
                  uri: "https://lh3.googleusercontent.com/aida-public/AB6AXuDZqLKINCgRok7E9QnYQMO-NetLoVot7YJ82Z_599vPCeJ_691WBG9-vydQfb1PEW-e7sy9E2SItn_Vdejx4AypOocQ6NY-RoI8dEX79llrw6Yih7p8DF3t1puGjw5g0EI8f9U4osqT0aXhzyiJRW4G3dDvLyyk9ry7DTWzxR_cRDEcSBU7OIxv0CeKz1xLaXPrnLZ_aKBwD14imrbPoLJTrUzUW-wuGk72XnhPK7FC08crUYEoxlGwbW5BuFOBlEEPRtqqf_g3YqR6",
                }}
            ...
            <View style={styles.heroInfo}>
              ...
              <Text style={styles.userBio}>
                Dedicated to urban sustainability and community-driven policy
                reform. Member since 2022.
              </Text>
            </View>
          </View>
        ...
        <View style={styles.tabsContainer}>
          ...
          >
            <Text
              style={[
                styles.tabText,
                activeTab === "my_petitions" && styles.activeTabText,
              ]}
            >
              My Petitions
            </Text>
          ...
          >
            <Text
              style={[
                styles.tabText,
                activeTab === "signed" && styles.activeTabText,
              ]}
            >
              Signed
            </Text>
            ...
            {myPetitions.length > 0 ? (
              myPetitions.map((petition) => (
                <TouchableOpacity
                  ...
                  onPress={() =>
                    navigation.navigate("PetitionDetails", { id: petition.id })
                  }
                >
                  <Image
                    source={{
                      uri: "https://lh3.googleusercontent.com/aida-public/AB6AXuA9AJnFp93hNLSvk6sbH2HBt8bN3sWiW1jSG3PgsQ8ko0vby8f5v45qj1_Eyk3gm1sLbBLP_ghTw1vH3D_wKXDMPQbARvb3321Q8osgSzg2hqIOJX8RL5sDjmpvDbCmIDtQMyzc03Evgb5HjWJRQPy6a7CZ6BVH_IKapChsBbP4H_21b94jgE2NDicI2wbJJQPAiMmLukokmCaROapV7f5G1Hx80znF2vzZ4TC9Mipt4nE28I0WfIYNeX7Xs0FfcZ6ncf2WeB-PkWRJ",
                    }}
              ...
              <View style={styles.emptyState}>
                ...
                <Text style={styles.emptyDesc}>
                  You haven't launched any petitions. Your voice is needed!
                </Text>
                <TouchableOpacity
        ...
        <View style={styles.impactCard}>
          <View style={styles.impactContent}>
            ...
            <Text style={styles.impactDesc}>
              Your voice has reached 142,000 people this month.
            </Text>
          </View>
